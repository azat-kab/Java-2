...
public class Main {
    ...
    private static float[] createArr(float[] arr){
    ...
    public static void oneThread() {
        ...
        calculation(arr);
        System.out.println("One thread method done calculation in " + (System.currentTimeMillis() - a) + " milliseconds");
    }
    ...
    public static void twoThreads() {
        ...
        System.out.println("Two threads method done calculation in " + (System.currentTimeMillis() - a) + " milliseconds");
    }
}
